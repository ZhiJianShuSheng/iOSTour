...
@interface WE_LaunchAdManager()<XHLaunchAdDelegate>

@end

@implementation WE_LaunchAdManager
+ (void)load{
    [self shareManager];
}

+ (WE_LaunchAdManager *)shareManager{
    static WE_LaunchAdManager *instance = nil;
    static dispatch_once_t oneToken;
    dispatch_once(&oneToken,^{
        instance = [[WE_LaunchAdManager alloc] init];
    });
    return instance;
}
