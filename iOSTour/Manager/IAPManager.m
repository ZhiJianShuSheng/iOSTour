...
- (void)failedTransaction:(SKPaymentTransaction *)transaction {
    ...
    XXLog(@"transaction.error.code = %ld", transaction.error.code);
...
- (void)checkIAPFiles{
    ...
    if (error == nil) {
        ...
        XXLog(@"AppStoreInfoLocalFilePath error:%@", [error domain]);
    }
}
