...
//                
//                // 授权信息
//                XXLog(@"QQ uid: %@", resp.uid);
//                XXLog(@"QQ openid: %@", resp.openid);
//                XXLog(@"QQ accessToken: %@", resp.accessToken);
//                XXLog(@"QQ expiration: %@", resp.expiration);
//                
//                // 用户信息
//                XXLog(@"QQ name: %@", resp.name);
//                XXLog(@"QQ iconurl: %@", resp.iconurl);
//                XXLog(@"QQ gender: %@", resp.unionGender);
//                
//                // 第三方平台SDK源数据
//                XXLog(@"QQ originalResponse: %@", resp.originalResponse);
